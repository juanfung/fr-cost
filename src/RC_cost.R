...
H = sum(rep(c(15,13),times=c(1,11)))           # Building height (ft)
...
gravity <- data.frame("story"=1:n_story,
                      "d"=(rep(c(24),times=c(12))),
                      "b"=(rep(c(24),times=c(12))),
                      "h"=(rep(c(15,13),times=c(1,11))),
                      "ratio"=(rep(c(0.025),times=c(12))),
                      "sh_ratio"=(rep(c(0.0093),times=c(12))),
                      "sh_spacing"=(rep(c(3.5),times=c(12)))
)
...
column <- data.frame("story"=1:n_story,
                    ...
                    "ex_ratio"=(rep(c(0.0182,0.0109),times=c(1,11))),
                    "insh_ratio"=(rep(c(0.0093),times=c(12))),
                    "insh_spacing"=(rep(c(3.5),times=c(12))),
                    "exsh_ratio"=(rep(c(0.0093,0.0070),times=c(1,11))),
                    "exsh_spacing"=(rep(c(3.5),times=c(12)))
)
...
slab <- data.frame("story"=1:n_story,
                   "d"=(rep(c(d_slab),times=c(12))),
                   "b"=(rep(c(l_slab),times=c(12))),
                   "l"=(rep(c(l_slab),times=c(12)))
)
